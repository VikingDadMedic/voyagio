...
const DesktopNav = () => {
	...
	return (
		<div className="box-border fixed w-full py-4 text-gray-100 border-b border-b-slate-800 bg-slate-950">
			<div className="flex items-center justify-between m-auto text-xl font-bold max-w-7xl">
				<NavLink className="mr-4" to="/">
					<img src="/logo_1.svg" className="h-[58px] rounded-full" alt="le travel itinerary logo" />
				</NavLink>
				<div>
